...
function setPlan(plan) {
  ...
  document.querySelectorAll(".periodo").forEach((el) => {
    el.textContent = anual ? "año" : "mes";
  });

  btnMensual.className =
    "px-5 py-2 rounded-full " +
    (anual ? "text-gray-500" : "bg-white shadow text-gray-900");
...
function toggleProyectos() {
  ...
  const expandido = extras[0].classList.contains("hidden") === false;
